...
class WidgetComponentActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { WidgetComponentFactory.createComponentActor() } }
