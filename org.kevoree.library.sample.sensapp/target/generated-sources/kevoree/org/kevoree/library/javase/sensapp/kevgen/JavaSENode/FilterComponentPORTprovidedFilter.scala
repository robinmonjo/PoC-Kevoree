...
class FilterComponentPORTprovidedFilter(component : FilterComponent) extends org.kevoree.framework.MessagePort with KevoreeProvidedPort {
def getName : String = "providedFilter"
