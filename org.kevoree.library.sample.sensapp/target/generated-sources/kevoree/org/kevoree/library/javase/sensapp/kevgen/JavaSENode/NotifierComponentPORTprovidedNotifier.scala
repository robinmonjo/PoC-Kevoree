...
class NotifierComponentPORTprovidedNotifier(component : NotifierComponent) extends org.kevoree.framework.MessagePort with KevoreeProvidedPort {
def getName : String = "providedNotifier"
