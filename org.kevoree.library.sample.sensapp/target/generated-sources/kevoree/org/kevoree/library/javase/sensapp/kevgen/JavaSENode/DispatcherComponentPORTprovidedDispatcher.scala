...
class DispatcherComponentPORTprovidedDispatcher(component : DispatcherComponent) extends org.kevoree.framework.MessagePort with KevoreeProvidedPort {
def getName : String = "providedDispatcher"
