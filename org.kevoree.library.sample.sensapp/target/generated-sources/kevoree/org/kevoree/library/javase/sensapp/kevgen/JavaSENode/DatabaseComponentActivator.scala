...
class DatabaseComponentActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { DatabaseComponentFactory.createComponentActor() } }
