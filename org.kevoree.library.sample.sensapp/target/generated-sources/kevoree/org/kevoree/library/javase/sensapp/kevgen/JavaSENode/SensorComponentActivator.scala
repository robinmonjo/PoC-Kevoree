...
class SensorComponentActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { SensorComponentFactory.createComponentActor() } }
