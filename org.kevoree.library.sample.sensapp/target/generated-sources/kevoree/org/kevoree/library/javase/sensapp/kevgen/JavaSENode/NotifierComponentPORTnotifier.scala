...
class NotifierComponentPORTnotifier(component : NotifierComponent) extends org.kevoree.framework.MessagePort with KevoreeProvidedPort {
def getName : String = "notifier"
